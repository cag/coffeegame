...
(function() {
  define(function() {
    ...
    projectShapeOntoAxis = function(shape, axis) {
      var hw_proj, l, len, max, min, point, pt_proj, pts, stype;
    ...
    calcShapePolygonMinimumPenetrationVector = function(s, sx, sy, p, px, py, pen_amt, pen_dir, negate) {
      var abs_intersects, i, intersects, l, normal, p_bounds, proj_p_pos, proj_s_pos, ref, s_bounds;
      if (pen_amt == null) {
      ...
      for (i = l = 0, ref = p.normals.length; l < ref; i = l += 1) {
        normal = p.normals[i];
    ...
    calcPolyBounds = function(points) {
      var l, len, maxx, maxy, minx, miny, point;
      minx = points[0][0];
      maxx = points[0][0];
      miny = points[0][1];
      maxy = points[0][1];
    ...
    return {
      ...
      Polygon: (function() {
        function _Class(points) {
          var bounds_on_normal, bounds_on_normals, ccw, cross, edge1, edge2, i, j, k, l, len, len1, m, n, normal, normals, num_vertices, o, other, pt, ptslen, ref, ref1, skip, sumx, sumy;
          this.type = 'Polygon';
          ...
          for (i = m = 0, ref = ptslen; m < ref; i = m += 1) {
            j = (i + 1) % ptslen;
            k = (i + 2) % ptslen;
        ...
        _Class.prototype.subpath = function(context, offx, offy) {
          var coffx, coffy, i, l, len, m, normal, pts, ref, ref1;
          pts = this.points;
          context.moveTo(pts[0][0] + offx, pts[0][1] + offy);
          for (i = l = 1, ref = pts.length; l < ref; i = l += 1) {
      ...
      intersects: function(x_a, x_b, y_a, y_b, shape_a, shape_b) {
        var ref, ref1, result, test;
        test = (ref = intersection_test_map[shape_a.type]) != null ? ref[shape_b.type] : void 0;
        if (test != null) {
          return test(shape_a, x_a, y_a, shape_b, x_b, y_b);
        } else {
          test = (ref1 = intersection_test_map[shape_b.type]) != null ? ref1[shape_a.type] : void 0;
          if (test != null) {
