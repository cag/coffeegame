  ...
  define(['jquery', './game', './entity', './geometry', './util'], function($, game, entity, geometry, util) {
    ...
    TileSet = (function() {
      ...
      TileSet.prototype.setupTileMapping = function() {
        ...
        this.tiles = (function() {
          var _i, _results;
          _results = [];
          for (i = _i = 0; 0 <= numt ? _i < numt : _i > numt; i = 0 <= numt ? ++_i : --_i) {
            _results.push(grabTile(i % numtx, (i / numtx) | 0));
          }
          return _results;
        })();
      };
    ...
    TileLayer = (function(_super) {
      ...
      function TileLayer(json_data, map) {
        var height, i, j, parseGID, width, _ref;
          ...
          for (i = _i = 0; 0 <= width ? _i < width : _i > width; i = 0 <= width ? ++_i : --_i) {
            _results.push((function() {
              ...
              for (j = _j = 0; 0 <= height ? _j < height : _j > height; j = 0 <= height ? ++_j : --_j) {
                _results1.push(parseGID(json_data.data[i + j * width]));
              }
              return _results1;
            })());
          }
        ...
        if (((_ref = this.properties) != null ? _ref.parallax : void 0) != null) {
      ...
      TileLayer.prototype.buildCache = function() {
        ...
        this.cache = (function() {
          var _i, _results;
          _results = [];
          for (i = _i = 0; _i < cw; i = _i += 1) {
            _results.push((function() {
              var _j, _results1;
              _results1 = [];
              for (j = _j = 0; _j < ch; j = _j += 1) {
                _results1.push(cacheBlock(i * lcf, j * lcf));
              }
              return _results1;
            })());
          }
      ...
      TileLayer.prototype.drawRaw = function(context, lowtx, hightx, lowty, highty, dx, dy) {
        var data, datum, i, j, map, th, tw, _i, _j;
        map = this.map;
        tw = map.tilewidth;
        th = map.tileheight;
        data = this.data;
        for (i = _i = lowtx; _i < hightx; i = _i += 1) {
          for (j = _j = lowty; _j < highty; j = _j += 1) {
            datum = data[i][j];
      ...
      TileLayer.prototype.draw = function(context, targx, targy) {
        var bh, bw, cache, cam, cambounds, destx, desty, h, highbx, highby, hightx, highty, i, j, lcf, lowbx, lowby, lowtx, lowty, map, mlcamxwp, mlcamywp, mlsx, mlsy, th, tw, w, _i, _j;
        map = this.map;
        cam = map.camera;
        ...
        if (layers_cached) {
          ...
          for (i = _i = lowbx; _i < highbx; i = _i += 1) {
            for (j = _j = lowby; _j < highby; j = _j += 1) {
    ...
    ObjectLayer = (function(_super) {

      __extends(ObjectLayer, _super);

      function ObjectLayer(json_data, map) {
        var Aabb, Entity, Point, Polygon, Polyline, constructBitmask, ent, i, l_collides, l_obstructs, l_onCollide, l_onObstruct, mapents, object, objects, objh, objhwx, objhwy, objw, objx, objy, point, point_a, point_b, setupEntityWithProperties, tryGettingCallbackForName, tryMakingBitmaskFromString, _i, _j, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
        ...
        l_collides = tryMakingBitmaskFromString((_ref = this.properties) != null ? _ref.collides : void 0);
        l_onCollide = tryGettingCallbackForName((_ref1 = this.properties) != null ? _ref1.onCollide : void 0);
        l_obstructs = tryMakingBitmaskFromString((_ref2 = this.properties) != null ? _ref2.obstructs : void 0);
        l_onObstruct = tryGettingCallbackForName((_ref3 = this.properties) != null ? _ref3.onObstruct : void 0);
        setupEntityWithProperties = function(ent, object) {
          var obj_collides, obj_obstructs, obj_onCollide, obj_onObstruct, _ref4, _ref5, _ref6, _ref7, _ref8;
          ent.onStart = tryGettingCallbackForName((_ref4 = object.properties) != null ? _ref4.onStart : void 0);
          obj_onCollide = tryGettingCallbackForName((_ref5 = object.properties) != null ? _ref5.onCollide : void 0);
          if (obj_onCollide != null) {
            ent.onCollide = obj_onCollide;
          } else {
            ent.onCollide = l_onCollide;
          }
          obj_onObstruct = tryGettingCallbackForName((_ref6 = object.properties) != null ? _ref6.onObstruct : void 0);
          ...
          ent["static"] = true;
          obj_collides = tryMakingBitmaskFromString((_ref7 = object.properties) != null ? _ref7.collides : void 0);
          ent.collides = l_collides | obj_collides;
          obj_obstructs = tryMakingBitmaskFromString((_ref8 = object.properties) != null ? _ref8.obstructs : void 0);
        ...
        for (_i = 0, _len = objects.length; _i < _len; _i++) {
          ...
          if (object.polygon != null) {
            ...
            for (i = _j = 0, _ref4 = object.polyline.length - 1; _j < _ref4; i = _j += 1) {
        ...
        this.onStart = tryGettingCallbackForName((_ref5 = this.properties) != null ? _ref5.onStart : void 0);
        return;
      }
      ...
      ObjectLayer.prototype.draw = function(context, targx, targy) {
        var cam, ent, ents, map, xoff, yoff, _i, _len;
        map = this.map;
        cam = map.camera;
      ...
      ObjectLayer.prototype.debugDraw = function(context, targx, targy) {
        var cam, cambounds, camlx, camly, destx, desty, ent, h, map, w, xoff, yoff, _i, _len, _ref;
        map = this.map;
        cam = map.camera;
        cambounds = cam.shape.bounds_offsets;
    ...
    return {
      Map: (function() {
        ...
        function _Class(name, script, onload) {
          var cb_target;
          this.name = name;
          this.script = script;
          this.loaded = false;
        ...
        _Class.prototype.load = function(json_data, onload) {
          ...
          this.layers = (function() {
            ...
            _ref = json_data.layers;
            _results = [];
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
              l = _ref[_i];
              _results.push(createLayer(l));
            }
            return _results;
          })();
          ...
          this.tilesets = (function() {
            ...
            _results = [];
            for (_i = 0, _len = tilesets.length; _i < _len; _i++) {
              ts = tilesets[_i];
              _results.push(new TileSet(ts, ts_load_cb));
            }
            return _results;
          })();
        ...
        _Class.prototype.start = function() {
          var ent, layer, _i, _j, _len, _len1, _ref, _ref1;
          _ref = this.layers;
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            layer = _ref[_i];
        ...
        _Class.prototype.debugDraw = function(context, targx, targy) {
          var cam, ent, found_first, i, layer, xoff, yoff, _i, _j, _len, _ref, _ref1;
          cam = this.camera;
          xoff = targx - cam.x;
          yoff = targy - cam.y;
          found_first = false;
          for (i = _i = 0, _ref = this.entities.length; _i < _ref; i = _i += 1) {
            ent = this.entities[i];
            if (ent.boundsIntersects(cam)) {
              ent.shapeSubpath(context, xoff, yoff);
              found_first = true;
